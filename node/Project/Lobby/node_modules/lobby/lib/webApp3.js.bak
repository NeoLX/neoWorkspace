...
var objTool = require(PATH.normalize(__dirname + '/../utils/objectTool.js'));
...
var WebApp = function (app, path) {
    ...
    this.init = function (app, path) {
        ...
        // this.on(WebApp.Handles.onStatusChange, this.statusChangeHandle);
    ...
    //状态变化总控
    // this._su = {};
    // this._su.statusChangeHandle = this.statusChangeHandle;
    // delete this._super.statusChangeHandle;
    // delete this.statusChangeHandle;
    // this.statusChangeHandle = function() {
	// 	console.log("sub status change handle before");
    //     this._su.statusChangeHandle();
